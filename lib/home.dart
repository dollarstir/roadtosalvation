...
class _HomeState extends State<Home> {
  ...
  Future<void> initRadioService() async {
    try {
      await _flutterRadioPlayer.init("Road To Salvation Ministry", "Live",
          "http://stream.zeno.fm/m6txq7vqp7zuv", "false");
  ...
  Future apiCall() async {
    http.Response response = await http.get("https://roadtosalvation.dollarstir.com/api.php");
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          width: double.infinity,
                                          height: 200,
                                          child: Image.network("https://roadtosalvation.dollarstir.com/upload/"+ snapshot.data[0]['vpic'],
                                            fit: BoxFit.fill,
                                        ...
                                        Container(
                                          child: Row(
                                            children: [
                                              RaisedButton.icon(
                                                onPressed: () {
                                                  Share.share("ROAD TO SALVATION MINISTRY\n \nBile verse of the day\n \n" + snapshot.data[0]['vtitle']+ ' \n' + snapshot.data[0]['vdetail'],
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                width: double.infinity,
                child: Image.network(
                "https://roadtosalvation.dollarstir.com/upload/${details['pic']}", 
                fit: BoxFit.fill,
